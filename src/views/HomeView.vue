...
/** Share of the snapshot that has been in for strictly fewer days. It ranks an
 *  animal against the others still in the shelter today, which is all a stock
 *  snapshot can rank against (CLAUDE.md §1.3). */
